...
void test_vector_extract_component()
{
   ...
   *      G R G   G G G  G R G
   *
   * We have 2 finished components: the horizontal road that spans from (-1, 0) to (1, 0)
   * and the castle between tiles (0, 0) and (0, -1)
   */

  /*igraph_vector_int_t comp;
  igraph_vector_int_t csize;
  igraph_integer_t count;
  igraph_connected_components(&sb.graph, &comp, &csize, &count, IGRAPH_WEAK);*/
